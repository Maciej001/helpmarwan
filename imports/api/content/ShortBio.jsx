...
export const ShortBio = ({}) => (
  <div className="ShortBio">
    <h1>Do you know someone who can hire Marwan Ghabin as front-end web developer? A 1-year contract can save his and his kids' life!</h1>
    ...
    <div className="ShortBioParagraph">
      ...
      <div className="ShortBioText">
        <p>
          Before the war in Libya,
          {` `}
          <a href="https://twitter.com/ghabi2">Marwan</a>
          {` `}
          was a computer engineer just like you and me. Today he is a refugee living in Spain.
